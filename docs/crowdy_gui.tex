...
\begin{figure}
\centering
\epsfig{file=img/TimelineView.eps, width= 250pt }
...
\begin{figure}
\centering
\epsfig{file=img/CrowdViewInTimeline.eps, width= 250pt }
...
\begin{figure}
\centering
\epsfig{file=img/ListView.eps, width= 250pt }
...
following columns: Period, Users and size of the crowd. Once a row of crowd is
...
mark his favourite crowds. This feature is present in the detailed view of the
...
\begin{figure}
\centering
\epsfig{file=img/Search.eps, width= 250pt }
\caption{Search}
\label{fig:Search}
\end{figure}
...
\begin{figure}
\centering
\epsfig{file=img/NetworkInList.eps, width= 250pt }
...
\begin{figure}
\centering
\epsfig{file=img/TweetsInList.eps, width= 250pt }
...
\begin{figure}
\centering
\epsfig{file=img/GraphInList.eps, width= 250pt }
...
to use our system to find seveal conversations that they find interesting.
